...
$(document).ready(function (){
	...
	if(type == 'edit') {
		...
		//如果是修改试题，设置试题默认值
		$('#qsnForm').form({
			url : "${pageContext.request.contextPath}/admin/shiti/updateStBiancheng.action",
			onSubmit : function() {
...
function loadStInfo(questionId) {
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/admin/shiti/getStBianchengById.action",
		dataType:"json",
		loadMsg : '数据装载中......',
		data:{"questionId":questionId},
		success:function(result) {
...
function loadBaseInfo() {
	loadCombotree();
	$('#qsnForm').form({
		url : "${pageContext.request.contextPath}/admin/shiti/saveStBiancheng.action",
		onSubmit : function() {
			return $('#qsnForm').form("validate");
		},
		success:function(data) {
