...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/admin/addExam.js"></script>
...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="background:#fafafa;border:0px;margin-bottom:10px;">
				...
				<div style="width:100%;float:left;">
					...
					<div style="width:auto">
						<h3>成绩发布</h3>
						<div class="div_line_left">
							<span style="padding-left: 20px;"><input type="radio" onclick="changeTimeValidateTrue(this);" name="scorePulic" value="1"/></span>
							指定时间发布
							<span style="padding-left: 5px;">
				...
				<div id="tab" class="easyui-tabs" style="background:#fafafa;">
					...
					<div title="用户/组" style="background:#fafafa;">
						...
						<div style="margin-top:30px;height: 400px;">
							<div style="text-align:center;width:100%;height:25px;padding:10px 0 0 0;background: none repeat scroll 0 0 rgb(235, 235, 235);background:#fafafa;">已添加用户</div>
	...
	<div id="addShiJuan" class="easyui-dialog" title="添加试卷" style="width:800px;height:400px;" data-options="modal : true,closed:true">
		<div class="easyui-panel "
			...
			<table id="addShiJuan_table" class="easyui-datagrid" toolbar="#ebar" style=""></table>
